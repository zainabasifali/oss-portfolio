  ...
  >
    ...
    <SwiperSlide>
      ...
      <Container className='mt-5'>
        ...
        <Button className='text-color rounded-pill button-white p-2'>
         ...
         <Row className='mt-5 d-flex justify-content-between'>
          <Col lg={3} md={5} sm={12}>
            ...
            <h2>Pricing 🚀</h2>
            <p className='text-color pricing-box-text'>
           ...
           <Col className='project-box pricing-box p-4' lg={3} md={5} sm={12}>
      ...
      <Container className='mt-5'>
         ...
         <hr/>
          ...
          <Col className='project-box' lg={2} md={5} sm={12}>
            <img src={client1} alt="Project 1" className="client-img w-100" />
            <hr/>
            <h6 className='text-center'>Destalayr</h6>
          </Col>
           <Col className='project-box p-4' lg={2} md={5} sm={12}>
             <img src={client2} alt="Project 1" className="client-img w-100" />
            <hr/>
            <h6 className='text-center'>Avon Vacuums</h6>
          </Col>
           <Col className='project-box p-4' lg={2} md={5} sm={12}>
            <img src={client3} alt="Project 1" className="client-img w-100" />
            <hr/>
            <h6 className='text-center'>Fudgee kids</h6>
          </Col>
          <Col className='project-box p-4' lg={2} md={5} sm={12}>
            <img src={client4} alt="Project 1" className="client-img w-100" />
            <hr/>
         ...
         <Row className='mt-5 d-flex  gap-5 justify-content-center'>
          <Col className='project-box' lg={2} md={5} sm={12}>
            <img src={client5} alt="Project 1" className="client-img w-100" />
            <hr/>
            <h6 className='text-center'>Liberty Paw</h6>
          </Col>
           <Col className='project-box p-4' lg={2} md={5} sm={12}>
             <img src={client6} alt="Project 1" className="client-img w-100" />
            <hr/>
      ...
      {/* Contact section */}
        <Container className='mt-5'>
          ...
          <Row className='mt-5 d-flex  gap-5 justify-content-center'>
            ...
            <div className='rounded social-icons'><img src={linkedin} alt="Project 1" className="w-75 mt-1 ms-1" /></div>
            <div className='rounded social-icons'><img src={upwork} alt="Project 1" className="w-75 mt-1 ms-1" /></div>
          </div>
            </Col>
      ...
      {/* footer section */}
        <footer className='text-center mt-5'>
          ...
          <div className='d-flex justify-content-center gap-3 mt-3 mb-3'>
            <div className='rounded-pill social-icons'><img src={email} alt="Project 1" className="w-75 mt-1 ms-1" /></div>
            <div className='rounded-pill social-icons'><img src={whatsappp} alt="Project 1" className="w-75 mt-1" /></div>
          </div>
